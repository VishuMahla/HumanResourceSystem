...
$(function () {
  ...
  function generateEmployeeId() {
    ...
    const lastId = employees.length > 0
      ? parseInt(employees[employees.length - 1].employeeId.replace('EMP', ''))
      : 1000;
  ...
  const requiredFields = [
    '#employeeName', '#email', '#mobile', '#gender',
  ...
  /* ── Live Validation ──────────────────────────────────────── */
  HRMSValidation.attachLive('#employeeName',   'required', { message: 'Employee name is required.' });
  ...
  HRMSValidation.attachLive('#address',        'required', { message: 'Address is required.' });
  ...
  $('#employeeForm').on('submit', function (e) {
    ...
    const rules = [
      { field: '#employeeName',  type: 'required', label: 'Employee Name' },
    ...
    showToast(`Employee ${employee.employeeName} registered successfully!`, 'success', 4000);
  });
